...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 36]
...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 40]
...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 44]
    \begin{premise}
...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 42]
...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 43]
...
\begin{citecallout}[\textcite{marcus_algebraic_mind} p. 45]
